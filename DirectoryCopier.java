...
public class DirectoryCopier {
   ...
   */
  public DirectoryCopier(File soursceDirectory, File targetDirectory) {
    this.soursceDirectory = soursceDirectory;
    this.targetDirectory = targetDirectory;
  }

  /**
   * Метод copyDirectory() выполняет копирование файлов из исходной директории в целевую. Если
